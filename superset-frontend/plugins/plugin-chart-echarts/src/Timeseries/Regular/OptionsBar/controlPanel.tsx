  ...
  controlPanelSections: [
    ...
    },
    {
      ...
      controlSetRows: [
        ...
        [
          {
            name: 'optionsBarDropdownColumns',
            config: {
              type: 'SelectControl',
              label: t('Dropdown columns'),
              multi: true,
              freeForm: false,
              clearable: true,
              renderTrigger: true,
              description: t(
                'Choose dataset columns shown in the top-right column dropdown. Leave empty to show all columns.',
              ),
              shouldMapStateToProps: () => true,
              mapStateToProps: state => {
                const columns = Array.from(
                  new Set(
                    ensureIsArray((state.datasource as any)?.columns)
                      .map(
                        (column: any) =>
                          column?.column_name ??
                          column?.label ??
                ...
                return {
                  choices: columns.map(column => [column, column]),
                };
              },
            },
          },
        ...
        [
          {
            name: 'optionsBarVisibleDropdowns',
            config: {
              type: 'SelectControl',
              label: t('Visible extra dropdowns'),
              multi: true,
              freeForm: false,
              clearable: true,
              renderTrigger: true,
              default: ['orientation', 'stack', 'column'],
              description: t(
                'Choose which dropdown controls are shown in the top-right extra controls area.',
              ),
              choices: [
                ['orientation', t('Orientation')],
                ['stack', t('Stacked Style')],
                ['column', t('Column')],
              ],
            },
          },
        ...
        [
          {
            name: 'optionsBarOrientationLabel',
            config: {
              type: 'TextControl',
              label: t('Orientation dropdown label'),
              renderTrigger: true,
        ...
        [
          {
            name: 'optionsBarStackLabel',
            config: {
              type: 'TextControl',
              label: t('Stack dropdown label'),
              renderTrigger: true,
              default: t('Stacked Style'),
            },
          },
        ],
        [
          {
            name: 'optionsBarColumnLabel',
            config: {
              type: 'TextControl',
              label: t('Column dropdown label'),
              renderTrigger: true,
              default: t('Column'),
            },
          },
        ...
        [
          {
            name: 'optionsBarDatasetColumn',
            config: {
              type: 'SelectControl',
              label: t('Selected dropdown column'),
              multi: false,
              freeForm: false,
              clearable: true,
              renderTrigger: true,
              description: t(
                'Default selected column for the top-right column dropdown.',
              ),
              shouldMapStateToProps: () => true,
              mapStateToProps: state => {
                const columns = Array.from(
